	   ...
	   private userRepository repo;
		  ...
		  public void getUsersTest() { 
		       when(repo.findAll()).thenReturn(Stream
					  .of(new Signup("sai","S1234","S1234",12345423 ,"sai@1234"),
					            new Signup("jash","J2345","J2345",234123432,"jas@7865")).collect(Collectors.toList()));
		...
		public void saveuserTest() {
			Signup user = new Signup("jahn","J4567","J4567",612312421 ,"jahn@4321");
